...
import { defaultStorage } from './hterm'
import LibPreferenceManager from 'reterm-libdot/lib/PreferenceManager'
 ...
 */
const PreferenceManager = function(profileId) {
  LibPreferenceManager.call(this, defaultStorage,
                             '/hterm/profiles/' + profileId);
  var defs = PreferenceManager.defaultPreferences;
  Object.keys(defs).forEach(function(key) {
    this.definePreference(key, defs[key][1]);
  }.bind(this));
};

PreferenceManager.categories = {};
PreferenceManager.categories.Keyboard = 'Keyboard';
PreferenceManager.categories.Appearance = 'Appearance';
PreferenceManager.categories.CopyPaste = 'CopyPaste';
PreferenceManager.categories.Sounds = 'Sounds';
PreferenceManager.categories.Scrolling = 'Scrolling';
PreferenceManager.categories.Encoding = 'Encoding';
PreferenceManager.categories.Miscellaneous = 'Miscellaneous';

/**
 * List of categories, ordered by display order (top to bottom)
 */
PreferenceManager.categoryDefinitions = [
  { id: PreferenceManager.categories.Appearance,
    text: 'Appearance (fonts, colors, images)'},
  { id: PreferenceManager.categories.CopyPaste,
    text: 'Copy & Paste'},
  { id: PreferenceManager.categories.Encoding,
    text: 'Encoding'},
  { id: PreferenceManager.categories.Keyboard,
    text: 'Keyboard'},
  { id: PreferenceManager.categories.Scrolling,
    text: 'Scrolling'},
  { id: PreferenceManager.categories.Sounds,
    text: 'Sounds'},
  { id: PreferenceManager.categories.Miscellaneous,
    text: 'Misc.'}
];
...
PreferenceManager.defaultPreferences = {
  'alt-gr-mode':
  [PreferenceManager.categories.Keyboard, null,
  ...
  [PreferenceManager.categories.Keyboard, false, 'bool',
  ...
  'alt-sends-what':
  [PreferenceManager.categories.Keyboard, 'escape',
  ...
  'audible-bell-sound':
  [PreferenceManager.categories.Sounds, 'lib-resource:hterm/audio/bell',
   'url',
   'URL of the terminal bell sound.  Empty string for no audible bell.'],

  'desktop-notification-bell':
  [PreferenceManager.categories.Sounds, false, 'bool',
  ...
  'background-color':
  [PreferenceManager.categories.Appearance, 'rgb(16, 16, 16)', 'color',
   'The background color for text with no other color attributes.'],

  'background-image':
  [PreferenceManager.categories.Appearance, '', 'string',
  ...
  [PreferenceManager.categories.Appearance, null, 'value',
  ...
  'close-on-exit':
  [PreferenceManager.categories.Miscellaneous, true, 'bool',
   'Whether or not to close the window when the command exits.'],

  'cursor-blink':
  [PreferenceManager.categories.Appearance, false, 'bool',
   'Whether or not to blink the cursor by default.'],

  'cursor-blink-cycle':
  [PreferenceManager.categories.Appearance, [1000, 500], 'value',
  ...
  'cursor-color':
  [PreferenceManager.categories.Appearance, 'rgba(255, 0, 0, 0.5)',
   'color',
  ...
  'copy-on-select':
  [PreferenceManager.categories.CopyPaste, true, 'bool',
   'Automatically copy mouse selection to the clipboard.'],

  'use-default-window-copy':
  [PreferenceManager.categories.CopyPaste, false, 'bool',
  ...
  [PreferenceManager.categories.Keyboard, true, 'bool',
  ...
  'enable-bold':
  [PreferenceManager.categories.Appearance, null, 'tristate',
  ...
  [PreferenceManager.categories.Appearance, true, 'bool',
  ...
  'enable-dec12':
  [PreferenceManager.categories.Miscellaneous, false, 'bool',
   'Respect the host\'s attempt to change the cursor blink status using ' +
   'DEC Private Mode 12.'],

  'environment':
  [PreferenceManager.categories.Miscellaneous, {'TERM': 'xterm-256color'},
   'value',
  ...
  'font-size':
  [PreferenceManager.categories.Appearance, 15, 'int',
   'The default font size in pixels.'],

  'font-smoothing':
  [PreferenceManager.categories.Appearance, 'antialiased', 'string',
   'CSS font-smoothing property.'],

  'foreground-color':
  [PreferenceManager.categories.Appearance, 'rgb(240, 240, 240)', 'color',
  ...
  'keybindings':
  [PreferenceManager.categories.Keyboard, null, 'value',
  ...
  'max-string-sequence':
  [PreferenceManager.categories.Encoding, 100000, 'int',
  ...
  'mouse-paste-button':
  [PreferenceManager.categories.CopyPaste, null,
   [null, 0, 1, 2, 3, 4, 5, 6],
  ...
  'pass-alt-number':
  [PreferenceManager.categories.Keyboard, null, 'tristate',
  ...
  'receive-encoding':
  [PreferenceManager.categories.Encoding, 'utf-8', ['utf-8', 'raw'],
   'Set the expected encoding for data received from the host.\n' +
   '\n' +
   'Valid values are \'utf-8\' and \'raw\'.'],

  'scroll-on-keystroke':
  [PreferenceManager.categories.Scrolling, true, 'bool',
   'If true, scroll to the bottom on any keystroke.'],

  'scroll-on-output':
  [PreferenceManager.categories.Scrolling, false, 'bool',
  ...
  [PreferenceManager.categories.Scrolling, 1, 'int',
