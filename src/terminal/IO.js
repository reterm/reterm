 ...
 */
IO.prototype.showOverlay = function(message, opt_timeout) {
...
/**
 * Create a new IO instance and make it active on the Terminal
...
IO.prototype.onTerminalResize_ = function(width, height) {
  var obj = this;
  while (obj) {
