...
import { getClientWidth, getClientHeight, getClientSize } from './hterm'
 ...
 */
ScrollPort.prototype.setFontFamily = function(fontFamily, opt_smoothing) {
...
ScrollPort.prototype.getScreenSize = function() {
  var size = getClientSize(this.screen_);
  return {
    height: size.height,
...
ScrollPort.prototype.measureCharacterSize = function(opt_weight) {
  ...
  var rulerSize = getClientSize(this.rulerSpan_);

  var size = new Size(rulerSize.width / this.ruler_.textContent.length,
                            rulerSize.height);
...
ScrollPort.prototype.resize = function() {
  this.currentScrollbarWidthPx = getClientWidth(this.screen_) -
...
ScrollPort.prototype.syncRowNodesDimensions_ = function() {
  ...
  this.visibleRowCount = f.smartFloorDivide(
  ...
  while (node) {
    topFoldOffset += getClientHeight(node);
...
ScrollPort.prototype.getScrollMax_ = function(e) {
  return (getClientHeight(this.scrollArea_) +
          this.visibleRowTopMargin + this.visibleRowBottomMargin -
          getClientHeight(this.screen_));
};
 ...
 * mouse wheel events.
 */
ScrollPort.prototype.setScrollWheelMoveMultipler = function(multiplier) {
