 ...
 */
const Frame = function(terminal, url, opt_options) {
 ...
 */
Frame.prototype.onMessage_ = function(e) {
 ...
 */
Frame.prototype.onMessage = function() {};

/**
 * Handle iframe onLoad event.
 */
Frame.prototype.onLoad_ = function() {
...
Frame.prototype.sendTerminalInfo_ = function() {
  f.getAcceptLanguages(function(languages) {
 ...
 */
Frame.prototype.onCloseClicked_ = function() {
  this.close();
};
 ...
 */
Frame.prototype.postMessage = function(name, argv) {
